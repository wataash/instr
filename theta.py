...
input('Right click substrate right upper edge and press enter.')
...
theta_pattern_tilld = math.atan((y111_tilled - y11_tilled) / (x111_tilled - x11_tilled)) * 180 / math.pi  # -0.7624002793812416
theta_diagonal = theta_diagonal_tilled - theta_pattern_tilld  # 21.44501633542317
(x11, y11) = rotate_vector(x11_tilled, y11_tilled, -theta_pattern_tilld)  # -409.42796355219554, -421.4851630383946
